...
public class GameData {
    ...
    @Expose
    private GameVisitorTeam visitorTeam;
    ...
    public GameHomeTeam getHomeTeam() {
        return homeTeam;
    }

    public void setHomeTeam(GameHomeTeam homeTeam) {
    ...
    public GameVisitorTeam getVisitorTeam() {
        return visitorTeam;
    }

    public void setVisitorTeam(GameVisitorTeam visitorTeam) {
